...
public enum ResponseCode {
    ...
    LOGIN_INFO_EMPTY(2012, "username or password cannot be blank"),
    PERMISSION_DENIED(2013, "permission denied"),
    LOGIN_FAILED(2014, "username or password is invalid"),
    ...
    AUTHING_EMAIL_LOGIN_FAILED(2020, "failed to login by email"),

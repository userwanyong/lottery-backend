...
VALUES (12, 12, '12', '12', '2025-06-15 15:45:24', '2025-06-15 15:45:25', 'close', '2025-06-15 15:45:28',
        '2025-06-15 16:46:32'),
       (123, 123, '123', '123', '2025-06-15 15:46:32', '2025-06-15 15:46:33', 'open', '2025-06-15 15:47:42',
        '2025-06-15 16:46:32'),
       (100301, 200001, '测试活动test', '测试活动test', '2025-03-05 22:17:16', '2029-06-05 22:17:18', 'open',
        '2025-03-05 22:17:20', '2025-06-15 16:46:32');
/*!40000 ALTER TABLE `activity`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (9011, 100301, 11101, 20000, 199870, 1.99, '2025-03-11 22:12:56', '2025-06-15 16:41:18'),
       (9012, 100301, 11102, 20000, 199549, 5.99, '2025-05-07 23:33:24', '2025-06-15 16:41:18');
/*!40000 ALTER TABLE `activity_sku`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `award`
    DISABLE KEYS */;
INSERT INTO `award`
VALUES (100, 'user_credit_blacklist', '1', '黑名单积分', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (101, 'user_credit_random', '1,100', '随机积分', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (102, 'openai_use_count', '5', 'OpenAI 增加使用次数', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (103, 'openai_use_count', '10', 'OpenAI 增加使用次数', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (104, 'openai_use_count', '20', 'OpenAI 增加使用次数', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (105, 'openai_model', 'gpt-4', 'OpenAI 增加模型', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (106, 'openai_model', 'dall-e-2', 'OpenAI 增加模型', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (107, 'openai_model', 'dall-e-3', 'OpenAI 增加模型', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (108, 'openai_use_count', '100', 'OpenAI 增加使用次数', '2025-02-17 13:16:03', '2025-06-15 16:51:00'),
       (109, 'openai_model', 'gpt-4,dall-e-2,dall-e-3', 'OpenAI 增加模型', '2025-02-17 13:16:03',
        '2025-06-15 16:51:00');
/*!40000 ALTER TABLE `award`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `rule`
    DISABLE KEYS */;
INSERT INTO `rule`
VALUES (1, 1200001, 101, 2, 'rule_random', '1,1000', '随机积分策略', '2025-02-17 13:16:03', '2025-06-15 17:02:56'),
       (2, 1200001, 107, 2, 'rule_lock', '1', '抽奖1次后解锁', '2025-02-17 13:16:03', '2025-06-15 17:02:56'),
       (3, 1200001, 108, 2, 'rule_lock', '2', '抽奖2次后解锁', '2025-02-17 13:16:03', '2025-06-15 17:02:56'),
       (4, 1200001, 109, 2, 'rule_lock', '6', '抽奖6次后解锁', '2025-02-17 13:16:03', '2025-06-15 17:02:56'),
       (5, 1200001, 107, 2, 'rule_luck_award', '1,100', '兜底奖品100以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (6, 1200001, 108, 2, 'rule_luck_award', '1,100', '兜底奖品100以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (7, 1200001, 101, 2, 'rule_luck_award', '1,10', '兜底奖品10以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (8, 1200001, 102, 2, 'rule_luck_award', '1,20', '兜底奖品20以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (9, 1200001, 103, 2, 'rule_luck_award', '1,30', '兜底奖品30以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (10, 1200001, 104, 2, 'rule_luck_award', '1,40', '兜底奖品40以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (11, 1200001, 105, 2, 'rule_luck_award', '1,50', '兜底奖品50以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (12, 1200001, 106, 2, 'rule_luck_award', '1,60', '兜底奖品60以内随机积分', '2025-02-17 13:16:03',
        '2025-06-15 17:02:56'),
       (13, 200001, NULL, 1, 'rule_weight',
        ...
        '2025-02-17 13:16:03', '2025-06-15 17:07:19'),
       (14, 200001, NULL, 1, 'rule_blacklist', '101:user001,user002,user003', '黑名单抽奖，积分兜底',
        '2025-02-17 13:16:03', '2025-06-15 17:07:19'),
       (15, 1200001, 107, 2, 'rule_lock', '1', '抽奖1次后解锁', '2025-02-17 13:16:03', '2025-06-15 17:02:56'),
       (16, 1200001, 108, 2, 'rule_lock', '2', '抽奖2次后解锁', '2025-02-17 13:16:03', '2025-06-15 17:02:56'),
       (17, 1200001, 109, 2, 'rule_lock', '6', '抽奖6次后解锁', '2025-02-17 13:16:03', '2025-06-15 17:02:56');
/*!40000 ALTER TABLE `rule`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (18, 200001, 101, '随机积分', NULL, 100000000, 99999813, 0.5000, 'tree_luck_award', 1, '2025-02-20 23:20:00',
        '2025-06-15 18:57:35'),
       (19, 200001, 102, 'OpenAI会员卡', NULL, 100000000, 99999997, 0.0500, 'tree_luck_award', 2, '2025-02-20 23:24:23',
        '2025-06-15 16:36:15'),
       (20, 200001, 103, '支付优惠券', NULL, 100000000, 99999983, 0.1000, 'tree_luck_award', 3, '2025-02-20 23:24:23',
        '2025-06-15 16:36:15'),
       (21, 200001, 104, '小米台灯', NULL, 100000000, 99999999, 0.0001, 'tree_luck_award', 4, '2025-02-20 23:24:23',
        '2025-06-13 17:01:50'),
       (22, 200001, 105, '小米su7周体验', '抽奖3次后解锁', 100000000, 99999983, 0.1000, 'tree_lock_3', 5,
        '2025-02-20 23:24:23', '2025-06-15 16:47:55'),
       (23, 200001, 106, '轻奢办公椅', '抽奖2次后解锁', 100000000, 99999992, 0.0500, 'tree_lock_2', 6,
        '2025-02-20 23:24:23', '2025-06-13 19:33:30'),
       (24, 200001, 107, '小霸王游戏机', '抽奖1次后解锁', 100000000, 99999987, 0.0500, 'tree_lock_1', 7,
        '2025-02-20 23:24:23', '2025-06-15 17:08:15'),
       (25, 200001, 108, '暴走玩偶', '', 100000000, 99999887, 0.1499, 'tree_luck_award', 8, '2025-02-20 23:24:23',
        '2025-06-15 17:08:10');
/*!40000 ALTER TABLE `strategy_award`
    ENABLE KEYS */;
UNLOCK TABLES;

CREATE database if NOT EXISTS `marketing_01` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use `marketing_01`;
...
(
    ...
    `award_id`    bigint(12)       NOT NULL COMMENT '奖品ID',
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户抽奖单表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户行为返利流水表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户积分流水表';
